...
public class GraphGuestInviter {
    ...
    public Invitation invite(String email, String redirectUrl, boolean sendInvitationMessage) {
        log.warn("EXEC_INVITE start email={} redirectUrl={} sendMessage={}", email, redirectUrl, sendInvitationMessage);
        ...
        log.warn("EXEC_INVITE success email={} invitedUserId={} redeemUrl={}",
